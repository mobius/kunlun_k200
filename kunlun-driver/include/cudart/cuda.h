...
typedef enum CUctx_flags_enum {
    ...
    CU_CTX_NAKED_PRIMARY       = 0x20, /**< Create naked primary context */
...
typedef enum CUdevice_attribute_enum {
    ...
    CU_DEVICE_ATTRIBUTE_CC_ARCH                         = 500,              /**< CC_ARCH, FOR INTERNAL USE ONLY */
    CU_DEVICE_ATTRIBUTE_OAM_ID                          = 501,              /**< OAM ID */
    CU_DEVICE_ATTRIBUTE_CURRENT_PCIE_GEN_X_LINK         = 502,              /*[KUNLUN][INTERNAL USE]*/
    CU_DEVICE_ATTRIBUTE_PCI_ADDRESS                     = 503,              /*[KUNLUN][INTERNAL USE]*/
    CU_DEVICE_ATTRIBUTE_MMU_ENABLED                     = 504,              /**< Device has MMU support enabled */
    CU_DEVICE_ATTRIBUTE_MMU_SSID                        = 505,              /**< MMU SSID */
...
typedef enum cudaError_enum {
    ...
    */
    ...
    /**
     * zhuanghaoqi:
     * This error indicates that the async copy failed for memory is too fragmented.
     */
    CUDA_ERROR_ASYNC_COPY_OUTPUT_OF_RANGE     = 911,
...
typedef enum CUmemKindType_enum {
    CU_MEM_KIND_TYPE_GLOBAL_MEM    = 0x0,
    CU_MEM_KIND_TYPE_L3_MEM        = 0x1,
    //CU_MEM_KIND_TYPE_CODE_MEM      = 0x2,
    //CU_MEM_KIND_TYPE_PARAM_MEM     = 0x3,
    //CU_MEM_KIND_TYPE_PRINTF_MEM    = 0x4,
    CU_MEM_KIND_TYPE_SYSCON_MEM    = 0x5,
} CUmemKindType;
...
CUresult CUDAAPI cuMemAllocEx(CUdeviceptr *dptr, size_t bytesize, CUmemKindType kind);
...
CUresult CUDAAPI cuHostPointerGetAttributes(unsigned int numAttributes, CUpointer_attribute *attributes, void **data, const void* hostPtr);
...
typedef enum CUdriverProcAddressQueryResult_enum {
    CU_GET_PROC_ADDRESS_SUCCESS = 0x0, /**< Symbol was succesfully found */
    CU_GET_PROC_ADDRESS_SYMBOL_NOT_FOUND = 0x1, /** <Symbol was not found in search */
    CU_GET_PROC_ADDRESS_VERSION_NOT_SUFFICIENT = 0x2, /** <Symbol was found but version supplied was not sufficient */
 ...
 * ::cudaGraphicsUnmapResources
 */
CUresult CUDAAPI cu_xpu_launch_config(unsigned int nclusters, unsigned int ncores, void *stream_in);

/**
 * \brief cu_xpu_launch_argument_set
 *
 * \param arg       - arg
 * \param sz        - sz
 * \param offset    - offset
 ...
 * ::cudaGraphicsUnmapResources
 */
CUresult CUDAAPI cu_xpu_launch_argument_set(const void *arg, size_t sz, size_t offset);

/**
 * \brief cu_xpu_launch_async
 *
 * \param kcpu       - kcpu
 *
 * \return
 ...
 * ::cudaGraphicsUnmapResources
 */
CUresult CUDAAPI cu_xpu_launch_async(void *kcpu);
 ...
 * ::cudaGraphicsUnmapResources
 */
CUresult CUDAAPI cu_xpu_wait(void *stream_in);

/**
 * \brief cu_xpu_last_kernel_exec_time
 *
 * \param time_ns    - time_ns
 *
 * \return
 * ::CUDA_SUCCESS,
 * ::CUDA_ERROR_UNKNOWN
 ...
 * ::cudaGraphicsUnmapResources
 */
CUresult CUDAAPI cu_xpu_last_kernel_exec_time(uint64_t *time_ns);

CUresult CUDAAPI cu_xpu_last_memcpy_time(uint64_t *time_ns);
...
/** @} */ /* END CUDA_XPU */
    ...
    CUresult CUDAAPI cuStreamIsCapturing(CUstream hStream, CUstreamCaptureStatus *captureStatus);
    CUresult CUDAAPI cuStreamGetCaptureInfo(CUstream hStream, CUstreamCaptureStatus *captureStatus, cuuint64_t *id);
    CUresult CUDAAPI cuStreamGetCaptureInfo_v2(CUstream hStream, CUstreamCaptureStatus *captureStatus, cuuint64_t *id, CUgraph *graph_out, const CUgraphNode **deps_out, size_t *numDeps_out);
