...
#if !NVCFG(GLOBAL_FEATURE_GR507_DELETE_DEPRECATED_CUDA_4_0)
/**
...
extern __host__ cudaError_t CUDARTAPI cudaHostPointerGetAttributes(struct cudaPointerAttributes *attributes, const void *ptr);
...
// NEW API cudaLaunchKernelGGL
#if defined(__cplusplus)

#define cudaLaunchKernelGGLInternal(kernelName, numBlocks, numThreads, memPerBlock, streamId, ...)  \
    do {                                                                                           \
        kernelName<<<(numBlocks), (numThreads), (memPerBlock), (streamId)>>>(__VA_ARGS__);         \
    } while (0)

#define cudaLaunchKernelGGL(kernelName, ...)  cudaLaunchKernelGGLInternal((kernelName), __VA_ARGS__)
