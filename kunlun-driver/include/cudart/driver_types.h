...
//#if NVCFG(GLOBAL_FEATURE_CTK2314_CUDA_ARRAY_DEFERRED_MAPPING)
...
#endif // NVCFG(GLOBAL_ARCH_HOPPER)
...
//#if NVCFG(GLOBAL_FEATURE_CTK2314_CUDA_ARRAY_DEFERRED_MAPPING)
    ...
    cudaDevAttrOamId                          = 501, /**< OAM ID */
    cudaDevCurrPCIeGenXLink                   = 502, /*[KUNLUN][INTERNAL USE]*/
    cudaDevAttrPciAddress                     = 503, /**< PCI dbdf */
    cudaDevAttrMmuEnabled                     = 504, /**< Device has MMU support enabled */
    cudaDevAttrMmuSsid                        = 505, /**< MMU SSID */
//#endif
    cudaDevAttrMax
};
...
#if NVCFG(GLOBAL_ARCH_HOPPER)
/* __TEMP_WAR__ bug 3316272: Since NVCFG cannot be used within the define of
 * cudaDevicePropDontCare, it is not possible to safely include a value in the
